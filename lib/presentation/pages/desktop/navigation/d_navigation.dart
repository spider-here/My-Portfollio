      ...
      ()=> Scaffold(
        appBar: AppBar(
          ...
          titleTextStyle: Theme
              ...
              .textTheme
              .titleSmall,
          toolbarHeight: pagesC.currentPageIndex > 0? 50.0 : 100.0,
          bottom: PreferredSize(preferredSize: const Size.fromHeight(0.8),
              child: pagesC.currentPageIndex > 0 ? const Divider(
                color: Colors.grey, thickness: 0.2, height: 0.8,)
          :const SizedBox()),
          actions: [
            TabButton(onClick: () {
              pagesC.pageJump(0);
            }, text: 'Home', index: 0, selectedIndex: pagesC.currentPageIndex,),
            TabButton(onClick: () {
              pagesC.pageJump(1);
            }, text: 'About', index: 1, selectedIndex: pagesC.currentPageIndex,),
            TabButton(onClick: () {
              pagesC.pageJump(2);
            },
              text: 'Services',
            ...
            AppIconButton(onClick: () {
              ...
              icon: themeC.dark.isTrue ? const Icon(Icons.wb_sunny_outlined) : const Icon(
